...
fetch('https://api.unsplash.com/collections/'+ collection_id + '/photos/?client_id='+ apiKey+'&per_page=50')
  ...
  .then(function(data) {
  	...
  	for (var i=0; i<data.length; i++) {
       ...
       `<div class="col-lg-4 col-sm-6"><div class="thumbnail"><a  target="_blank" href=` + data[i].links.html + `><img class="gallery" src= `+data[i].urls.small + `></a>`;  	
  	}
    })
